...
export const EditorData = () => (
  <div>
    <h3>
    Hello, I am Kostas Giovanitsas. A Software Developer.
    I'm a Full-Stack Software Developer. Creating is my passion. From user interface all the way to the background, We will work together for unique results!
    .......After acquiring my bachelor's degree in the Department of Computer, Informatics and Telecommunications Engineering at the International Hellenic University, I am searching for a job abroad.
    .......In a fast advancing technological world through countless difficulties and many successes, I have seen that the future is now and the road to achieve greatness is being built from those who fear no CHALLENGE.
    </h3>
  </div>
);
